        ...
        <div className="flex-1 flex justify-between sm:hidden">
            {hasPrevious ? (
                <PaginationLink page={page - 1} query={query}>
                    <a className="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm leading-5 font-medium rounded-md text-gray-700 bg-white hover:text-gray-500 transition ease-in-out duration-150">
                        Previous
                    </a>
                </PaginationLink>
            ) : (
            ...
            {hasNext ? (
                <PaginationLink page={page + 1} query={query}>
                    <a className="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm leading-5 font-medium rounded-md text-gray-700 bg-white hover:text-gray-500 transition ease-in-out duration-150">
                        Next
                    </a>
                </PaginationLink>
            ) : (
